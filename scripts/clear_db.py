#!/usr/bin/env python3
"""Clear all data from Gymkhana database tables.
...
TABLES_TO_CLEAR = [
    # Order matters due to foreign key constraints - clear children first
    "sub_agent_calls",
    "executions",
    "turns",
    "trajectories",
...
def main():
    parser = argparse.ArgumentParser(
        description="Clear all data from Gymkhana database tables"
    )
    parser.add_argument(
        "--confirm",
        action="store_true",
